<template>
  <div>
    <el-form ref="form" :model="form" label-width="80px" :rules="rules">
      ...
      <el-form-item label="调拨时间" prop="allocationTime">
         <el-date-picker
      ...
      <el-form-item label="申请人" prop="reporter">
       ...
       <el-form-item  label="说明" prop="descr">
        <el-input  type="textarea" v-model="form.descr" :row="4" placeholder="请输入调拨信息，含调拨的具体去向等"></el-input>
      </el-form-item>
      <el-form-item label="调拨设备"> 
          <div>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      for (let item of this.form.table) {
        ...
        this.$http({
          url: this.$http.adornUrl("/liferecord/addAllocation"),
          method: "post",
