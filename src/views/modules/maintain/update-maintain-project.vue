  ...
  <div>
      ...
      <el-form ref="form" :model="form" label-width="80px" :rules="rules">
        ...
        <el-row>
          ...
          <el-date-picker
              ...
              type="date"
              :placeholder="form.startDate == null ? '选择日期':form.startDate"
            ...
            <el-date-picker
              ...
              type="date"
              :placeholder="form.endDate == null ? '选择日期':form.endDate"
    ...
    <div>
      ...
      <el-table :data="form.table" style="width: 100%">
          ...
          <el-table-column prop="manufacture" label="供应商"></el-table-column>
          <el-table-column
            prop="devicemodel"
            label="部件型号"
          ></el-table-column>
  ...
  methods: {
    ...
    //   },
     getProDataList() {
        this.$http({
          ...
          if (data && data.code === 0) {
            console.log("maintainproject")
              console.log(data.maintainproject)
              this.form.proname = data.maintainproject.projectname
              this.form.proType = data.maintainproject.projecttype
              this.form.estimate = data.maintainproject.estimate
              this.form.startDate = data.maintainproject.starttime
              this.form.endDate = data.maintainproject.endtime
              if(data.maintainproject.state === '启用')
                this.form.state = true
              else
                this.form.state = false
            //   this.form.state = data.maintainproject.state
          }
        })
       this.getProMissionList()
       this.getProDeviceList()
    },
    ...
    getProMissionList () {
        ...
        this.$http({
          ...
          if (data && data.code === 0) {
            this.form.missiontable = data.data
    ...
    getProDeviceList(){
          this.$http({
            ...
            if (data && data.code === 0) {
              this.form.table = data.devicelist;
