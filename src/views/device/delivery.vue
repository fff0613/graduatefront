<template>
    ...
    <el-container>
      ...
      <el-button type="text" @click="dialogFormVisible=true">出库</el-button>
     <el-dialog title="出库" :visible.sync="dialogFormVisible">
        <el-form :model="form">
          <el-form-item label="出库原因">
            <el-input :model="form.reason" autocomplete="off" style="width:80%"></el-input>
          </el-form-item>
...
<el-table :data="tabledata" style="width: 100%" height="550">
   ...
   <el-table-column fixed label="操作">
        ...
        <el-button
          size="mini"
          @click="handleEdit(scope.$index, scope.row)">出库</el-button>
      </template>
    </el-table-column>
      <el-table-column
        fixed
