<template>
    ...
    <el-container>
     ...
     <el-dialog title="转移" :visible.sync="dialogFormVisible">
        <el-form :model="form">
    ...
    <el-button type="primary" @click="stockreturn">确 定</el-button>
  </div>
      </el-dialog>
      </el-header>
      <el-main>
<el-table :data="tabledata" style="width: 100%" height="550">
    ...
    <el-table-column fixed label="操作" width="100">
        ...
        <el-button
          size="mini"
          @click="handleEdit(scope.$index, scope.row)">退库</el-button>
      </template>
    </el-table-column>
      <el-table-column
        fixed
